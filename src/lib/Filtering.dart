        ...
        Center(
          child: OutlinedButton(
            ...
            onPressed: () {
              ...
              selected.add(major_category.substring(0,major_category.length-1));
            ...
            children: [
              Row(
                children: [
                  ...
                  GestureDetector(
                    child: Text(major_category[0],style: TextStyle(fontSize: 15),),
                    onTap: () {
                      setState(() {
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                child: Text(category[0],style: TextStyle(fontSize: 15),),
                                onTap: () {
                                  setState(() {
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Checkbox(
                                            activeColor: Colors.blue,
                                            value: _grandsonkeep.contains(sub_category[0]),
                                            onChanged: (e) {
                                                // Card 内のチェックボックスが選択されたら実行
                                          ...
                                          GestureDetector(
                                            child: Text(sub_category[0],style: TextStyle(fontSize: 15),),
                                            onTap: () {
                                              setState(() {
                                                if (_grandsonvisibility.contains(sub_category[0])) {
                                                  _grandsonvisibility.remove(sub_category[0]);
                                                } else {
                                                  // 選択されたらリストに追加する
                                                  _grandsonvisibility.add(sub_category[0]);
                                                }
                                              });
                                            },
                                          ),
...
class _Brand extends State<Brand>{
  final List<String> brand = ['ブランド1','ブランド2','ブランド3',];
...
class _Maker extends State<Maker>{ 
  final List<String> maker = ['メーカー1','メーカー2','メーカー3',];
...
class GenderAge_FilteringDialog extends StatefulWidget {
  @override
  GenderAge_FilteringDialogState createState() => GenderAge_FilteringDialogState();
}
            ...
            SizedBox( //性別ボタン
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    Text('性別   '),
                    gender_flag==false?//押す前は下向き矢印、押されたら上向き矢印
                    Icon(
            ...
            SizedBox( //年代ボタン
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    Text('年代   '),
                    age_flag==false?  //押す前は下向き矢印、押されたら上向き矢印
                    Icon(
                      Icons.expand_more_outlined,
                    ): Icon(
                      Icons.expand_less_outlined,
