...
class ProfileEditPage extends StatefulWidget {
  ProfileEditPage([this.newcreate, this.uid]);
  final newcreate;
  final uid;
  @override
  _ProfileEditPageState createState() => _ProfileEditPageState(newcreate, uid);
}
...
class _ProfileEditPageState extends State<ProfileEditPage> {
  _ProfileEditPageState([this.newcreate, this.uid]);
  final newcreate;
  final uid;
//選択画像
...
//好みの味覚ラジオボタン設定
  ...
  void age_check() {
    ...
    DateTime old = DateTime(int.parse(year_defaultValue),
        int.parse(month_defaultValue), int.parse(day_defaultValue)); //入力された生年月日
          ...
          children: [
            Padding(
              padding: EdgeInsets.symmetric(
                  ...
                  horizontal: media_width * 0.125),
              child: Column(
                children: [
                  Container(
                    margin:
                        EdgeInsets.symmetric(vertical: media_height * 0.066),
                    child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            padding:
                                EdgeInsets.only(right: media_width * 0.039),
                            ...
                            decoration: InputDecoration(
                              focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: HexColor('EC9361'), width: 1.5),
                              ),
                              ...
                              children: [
                                TableRow(children: [
                                  ...
                                  RadioListTile(
                                    ...
                                    groupValue: _gValue,
                                    onChanged: (value) =>
                                        gender_onRadioSelected(value, '秘密'),
                                  ),
                                ])
                              ],
                            )), // Container(
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SelectableText(age_label,
                                  scrollPhysics:
                                      NeverScrollableScrollPhysics()) //年代表示
                            ],
                          ),
                        ),
                      ],
                                ...
                                TableRow(
                                    ...
                                    children: [
                                      ...
                                      RadioListTile(
                                        ...
                                        groupValue: _tValue,
                                        onChanged: (value) =>
                                            taste_onRadioSelected(value, '濃味派'),
                                      ),
                                    ]),
                                TableRow(
                                    //味覚（甘口派・辛口派）
