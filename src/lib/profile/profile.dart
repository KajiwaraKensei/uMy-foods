...
import 'package:workspace/profile/profile_edit.dart';   //プロフィール編集
              ...
              child: Column(
                children: [ 
                      ...
                      BreadCrumb( //パンくずリスト
                        items: <BreadCrumbItem>[
                          ...
                          BreadCrumbItem(
                            content: TextButton(
                              onPressed: (){}, 
                              child: SelectableText('プロフィール',style: TextStyle(color: Colors.black),scrollPhysics: NeverScrollableScrollPhysics(),),
                            ),
                          ),
                        ],
                  ...
                  Container(  //プロフィール
                    ...
                    padding: EdgeInsets.symmetric(horizontal: media_width*0.02),
                    child: Row(
                      ...
                      children: [
                            ...
                            SizedBox(  //フォローボタン
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  primary: follow==true? HexColor('EC9361') :Colors.white ,
                                  side: BorderSide(color: HexColor('EC9361')),
                                ),
                                child: Text(follow==true?'フォロー中':'フォローする',style: TextStyle(color: follow==true? Colors.white:HexColor('EC9361')),),                                 
                                onPressed: (){
                                  setState(() {
                                    follow=!follow;
                                  });
                        ...
                        Column(   //プロフィール情報
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            SelectableText('れもん',style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,),scrollPhysics: NeverScrollableScrollPhysics()),
                            SelectableText('20代 / 女性 / 甘党 / 薄味 / 派量派',scrollPhysics: NeverScrollableScrollPhysics()),
                            Row(  //ランキング
                              children: [
                                FaIcon(FontAwesomeIcons.crown,color: HexColor('FFDF4C')),
                                SelectableText('今日のランキング1680位　',style: TextStyle(color: HexColor('EC9361')),scrollPhysics: NeverScrollableScrollPhysics()),
                                FaIcon(FontAwesomeIcons.crown,color: HexColor('FFDF4C')),
                                SelectableText('週間ランキング1680位　',style: TextStyle(color: HexColor('EC9361')),scrollPhysics: NeverScrollableScrollPhysics()),
                                FaIcon(FontAwesomeIcons.crown,color: HexColor('FFDF4C')),
                                SelectableText('月間ランキング1680位　',style: TextStyle(color: HexColor('EC9361')),scrollPhysics: NeverScrollableScrollPhysics()),
                              ],
                            ),
                            ...
                            SelectableText.rich(
                              TextSpan( //投稿・フォロワーなどの数値
                                children: [
                                  TextSpan(text: '72', style: TextStyle(fontWeight: FontWeight.bold,)),
                                  TextSpan(text: 'フォロー　|　'),
                                  TextSpan(text: '1728', style: TextStyle(fontWeight: FontWeight.bold,)),
                                  TextSpan(text: 'フォロワー　|　'),
                                  TextSpan(text: '482', style: TextStyle(fontWeight: FontWeight.bold,)),
                                  TextSpan(text: 'いいね　|　'),
                                  TextSpan(text: '50', style: TextStyle(fontWeight: FontWeight.bold,)),
                                  TextSpan(text: '投稿'),
                                ]
                              )
                            ),
                            SpaceBox.height(media_height*0.017),
                            SelectableText( //自己紹介（改行→https://qiita.com/gkn/items/f031bab66899e5886ce0 ）
                      ...
                      child:Row(
                        children: [
                          Expanded( //左側
                            flex: 3,
                            child: Container(
                              padding: EdgeInsets.only(right: media_width*0.03),
                              child: Column(
                                children: [
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Container(  //レビューバー
                                        ...
                                        decoration: BoxDecoration(
                                          border: Border(
                                            bottom: BorderSide(
                                              color:display!='レビュー'? HexColor('EC9361').withOpacity(0.3):HexColor('EC9361'),
                                              width: 3,
                                            ),
                                          )
                                        ),
                                        child: TextButton(
                                          style: ButtonStyle(
                                            overlayColor: MaterialStateProperty.all(HexColor('FFDFC5').withOpacity(0.3))
                                          ),
                                          child: Text('レビュー(45)',
                                            style: TextStyle(color: display!='レビュー'? HexColor('EC9361').withOpacity(0.3):HexColor('EC9361'),fontSize: 20)
                                          ),
                                          onPressed: (){
                                            setState(() {
                                              display='レビュー';
                                      ...
                                      Container(  //気になる食品バー
                                        ...
                                        decoration: BoxDecoration(
                                          border: Border(
                                            bottom: BorderSide(
                                              color: display!='食品'? HexColor('EC9361').withOpacity(0.3):HexColor('EC9361'),
                                              width: 3,
                                            ),
                                          )
                                        ),
                                        child: TextButton(
                                          ...
                                          child: Text('気になる食品(15)',
                                            style: TextStyle(color: display!='食品'? HexColor('EC9361').withOpacity(0.3):HexColor('EC9361'),fontSize: 20)
                                          ),
                                          onPressed: (){
                                            setState(() {
                                              display='食品';
                                  ...
                                  Visibility( //レビューの場合のみ表示
                                    visible: display=='レビュー',
                                    child: Container(
                                      padding: EdgeInsets.symmetric(vertical: media_height*0.08),
                                      child: Column(
                                        children: [
                                          for (int x = 0; x < 3; x++)
                                          Row(
                                    ...
                                    child:Column( 
                                      children: [
                                        Container( //お気に入りのメーカー
                                          ...
                                          child: Row( //お気に入りのメーカータイトル
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [ 
                                              Text('お気に入りのメーカー',
                                                style: TextStyle(color:HexColor('EC9361'),fontSize: 20)
                                              ),
                                              SizedBox(
                                        ...
                                        for(int x=0;x<maker_name.length;x++)   //メーカー名表示
                                        ListTile(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                width: media_width*0.027,
                                                child:
                                                    Image.asset('images/icon/newgoods.png'),
                                              ),
                                              SpaceBox.width(10),
                                              Text(
                                                '新商品',
                                                            ...
                                                            Expanded(
                                                              ...
                                                              child: GestureDetector(
                                                                child:Container(  //商品画像
                                                                  ...
                                                                  height: media_height*0.1477,
                                                                  width: media_width*0.07,
                                                                  child: Image.network('https://m.media-amazon.com/images/I/71WkOSqGsWS._AC_SL1500_.jpg'),
                                                                ) ,
                                                                onTap: () {
                                                                  setState(() {});  //商品詳細ページへ
                                                                },
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        flex: 2,
                                                                        child: ElevatedButton(  //クリップボタン
                                                                          child: Icon(
                                                                            Icons.assignment_turned_in,size:25
                                                                          ),
                                                                          style: ElevatedButton.styleFrom(
                                                                            padding: EdgeInsets.all(15),
                                                                            primary: HexColor('EC9361'),
