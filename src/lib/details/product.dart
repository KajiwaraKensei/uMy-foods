...
class _ProductPageState extends State<ProductPage> {
  ...
  String img3='https://m.media-amazon.com/images/I/61D6cymmZuS._AC_SL1000_.jpg';
  String img4='https://m.media-amazon.com/images/I/61U5RiR9kyS._AC_SL1000_.jpg';
  String img5='https://m.media-amazon.com/images/I/61E2OBPzmoS._AC_SL1000_.jpg';
                ...
                child: Column(
                  children: [
                    ...
                    Visibility(
                      ...
                      child: Padding(
                        padding:EdgeInsets.only(bottom: 20),
                        child: Text('たん白質（g）　2.1g/1袋（標準27.5g） 脂質（g）　6.8g/1袋（標準27.5g） 炭水化物（g）　18g/1袋（標準27.5g） ナトリウム（mg）　140mg/1袋（標準27.5g）')
                      ),
                    )
                  ],
                )
  ...
  Widget percent_indicator(String name,double persent) {
    ...
    return Padding(
      ...
      child: new LinearPercentIndicator(
        ...
        leading: Container(width: 60,child: Text(name),),
