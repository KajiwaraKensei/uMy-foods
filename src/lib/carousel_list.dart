...
rankingcarousel(var context, var mwidth, var mheight, var rankicon, String rankingtitle1, List<Map<String, dynamic>> Rankinglist1, List<String> category1, String rankingtitle2,
    List<Map<String, dynamic>> Rankinglist2, List<String> category2) {
  return Row(
                ...
                child: new InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailsPage(Rankinglist1[i]['product_id'], 'TOP'),
                        ));
                  },
                  child: Container(
                    width: mwidth * 0.245,
                ...
                child: new InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailsPage(Rankinglist2[i]['product_id'], 'TOP'),
                        ));
                  },
                  child: Container(
                    width: mwidth * 0.245,
...
newreviewcarousel(var mwidth, var mheight, List<Map<String, dynamic>> review, int i) {
  return Container(
    child: Card(
