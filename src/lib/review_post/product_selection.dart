                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    TextButton(
                                                                      ...
                                                                      child: SizedBox(
                                                                        height: 20,
                                                                        child: SelectableText('グリコ',scrollPhysics: NeverScrollableScrollPhysics(),style: TextStyle(color: Colors.black),), //メーカー
                                                                      )
                                                                    ),
                                                                    SizedBox(
                                                                      height: 20,
                                                                      child: SelectableText('つぶつぶいちごポッキー',scrollPhysics: NeverScrollableScrollPhysics(),), //商品名
                                                                    ),
                                                                    Row(  //星評価
                                                                      children: [
                                                                        star(3,25),
                                                                        SelectableText('500',style: TextStyle(color: HexColor('EC9361'),fontSize: 12),scrollPhysics: NeverScrollableScrollPhysics(),)
                                                                      ],
                                                                    ),
                                                                    Row(
                                                                      children: [
