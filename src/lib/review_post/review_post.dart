                        ...
                        children: [
                          ...
                          Container(  //評価
                            ...
                            child: Column(//
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SelectableText('・評価',style: TextStyle(fontSize: 16,color: HexColor('EC9361'),fontWeight: FontWeight.bold),scrollPhysics: NeverScrollableScrollPhysics()),
                                SpaceBox.height(20),
                                Container(
                          ...
                          Container(  //味覚
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SelectableText('・味覚',style: TextStyle(fontSize: 16,color: HexColor('EC9361'),fontWeight: FontWeight.bold),scrollPhysics: NeverScrollableScrollPhysics()),
                                SpaceBox.height(20),
                                Container(
                                  padding: EdgeInsets.symmetric(horizontal: 80),
                                  child: Table(
                          ...
                          Container(  //リピート
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SelectableText('・リピートしたいですか？',style: TextStyle(fontSize: 16,color: HexColor('EC9361'),fontWeight: FontWeight.bold),scrollPhysics: NeverScrollableScrollPhysics()),
                                SpaceBox.height(30),
                                Container(
                                  padding: EdgeInsets.symmetric(horizontal: 80),
                                  child: Row(
